            ...
            if dom == "py":
                ...
                with open('out.txt', 'a') as f:
                    if len(node.get_param())>0:
                        print(node.get_param()[0].type_+node.get_param()[0].declname+node.get_param()[0].defname+node.get_param()[0].array+node.get_param()[0].defval+node.get_param()[0].briefdescription, file=f)
